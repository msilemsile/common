...
public class SimpleCameraXActivity extends ImmerseFullScreenActivity {
    ...
    private void initData() {
        cameraHelper = getWeakRefHolder(CameraXHelper.class);
        ...
        cameraHelper.setCameraHelperCallback(new CameraXHelper.OnCameraHelperCallback() {
            ...
            public void onTakePictureError(String message) {
                AppAlertDialog.build().setTitleText("拍照失败")
                        ...
                        .setConfirmText("确定")
                        .show(SimpleCameraXActivity.this);
            }
    ...
    public static void goToPage(Context context) {
        Intent intent = new Intent(context, SimpleCameraXActivity.class);
